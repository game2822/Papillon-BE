...
export class Smartschool implements SchoolServicePlugin {
  ...
  capabilities: Capabilities[] = [Capabilities.REFRESH, Capabilities.NEWS, Capabilities.TIMETABLE, Capabilities.HOMEWORK, Capabilities.GRADES, Capabilities.ATTENDANCE];
